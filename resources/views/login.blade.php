...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Menorah | User Login </title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="Login page of menorah-app" name="description" />
        ...
        <div class="content">
            ...
            <form class="login-form" method="post" action="{{ route('login') }}">
                ...
                <div class="create-account">
                    <p>
                        <a href="javascript:;" id="register-btn" class="uppercase">Register New School</a>
                    </p>
                </div>
            </form>
            <!-- END LOGIN FORM -->
            ...
            <form class="register-form" method="post" action="{{route('registerSchool.store')}}">
                {{ csrf_field() }}
                <h3 class="font-green">Sign Up</h3>
                <p class="hint"> Enter your school details below: </p>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">School Name</label>
                    <input class="form-control placeholder-no-fix" type="text" placeholder="School Name" name="schoolName" required="" />
                ...
                <div class="form-group">
                    ...
                    <input class="form-control placeholder-no-fix" type="text" placeholder="Email" name="schoolEmail" value="gsmulbah2300@gmail.com" required="" /> 
                 ...
                 <div class="form-group">
                    ...
                    <input class="form-control placeholder-no-fix" type="text"  name="school_id" placeholder="School ID" />
                ...
                <div class="form-group">
                    ...
                    <input class="form-control placeholder-no-fix" type="text" placeholder="Address" name="address" value="KaKata"required="" />
                ...
                <div class="form-group">
                    ...
                    <input class="form-control placeholder-no-fix" type="text" placeholder="City/Town" name="city"  value="Monrovia" /> 
                        @if ($errors->has('city'))
                                    <span class="help-block">
