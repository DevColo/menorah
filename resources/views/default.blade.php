...
Version: 4.7.1
Author: KeenThemes
Website: http://www.menorah-app.com/
Contact: support@menorah-app.com
-->
...
<html lang="en">
    ...
    <head>
        ...
        <meta content="Preview page of menorah-app" name="description" />
        ...
        <link href="{!! asset('css/components.min.css') !!}" rel="stylesheet" id="style_components" type="text/css" />
          <link href="{!! asset('css/inputstyle.css') !!}" rel="stylesheet" id="style_components" type="text/css" />
        <link href="{!! asset('css/plugins.min.css') !!}" rel="stylesheet" type="text/css" />
        <!-- END THEME GLOBAL STYLES -->
        <!-- BEGIN PAGE LEVEL STYLES -->
        <!-- END PAGE LEVEL STYLES -->
        <!-- BEGIN THEME LAYOUT STYLES -->
        <link href="{!! asset('js/layout3/css/layout.min.css') !!}" rel="stylesheet" type="text/css" />
        <link href="{!! asset('js/layout3/css/themes/default.min.css') !!}" rel="stylesheet" type="text/css" id="style_color" />

        <link href="{!! asset('js/layout3/css/custom.min.css') !!}" rel="stylesheet" type="text/css" />
    ...
    <body class="page-container-bg-solid">
        <div class="page-wrapper">
            <div class="page-wrapper-row">
                <div class="page-wrapper-top navbar-fixed-top" style="margin-top:0px;">
                    <!-- BEGIN HEADER -->
                                ...
                                <div class="top-menu">
                                    <ul class="nav navbar-nav pull-right">
                                        ...
                                        <li class="dropdown dropdown-user dropdown-dark">
                                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
        <img alt="" class="img-circle" src="{{URL::asset('img/Student.png')}}" style="width: 30px;height: 30px;position: absolute;padding: 0px;top: 15px;
        right:0px;left: -21px;">
                                            ...
                                            <b style="top:16px;position: relative;left: 2px;">
                                            {{Auth::user()->name}}</b>
                                ...
                                <div class="hor-menu  ">
                                    <ul class="nav navbar-nav">
                                        <li aria-haspopup="true" class="menu-dropdown classic-menu-dropdown ">
                                            <a href="javascript:;"><i class="icon-bar-chart"></i> Dashboard
                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-content">
                                <div class="container" style="margin-left: 20px;">
                                    ...
                                    <div class="page-content-inner" style="margin:7%;">
                                       @if(Session::has('msg'))
            ...
            <div class="page-wrapper-row">
                <div class="page-wrapper-bottom">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12 footer-block">
                                    ...
                                    <address class="margin-bottom-40"> Phone: 800 123 3456
                                        <br> Email:
                                        <a href="mailto:info@metronic.com">info@bigintinc.com</a>
                                    </address>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="page-footer">
                        <div class="container"> <?php echo date('Y')?> &copy; BigInt Inc
...
<![endif]-->
        <!-- BEGIN CORE PLUGINS -->
        <script src="{!! asset('css/jquery.min.js') !!}" type="text/javascript"></script>
        <script src="{!! asset('css/bootstrap/js/bootstrap.min.js') !!}" type="text/javascript"></script>
        <script src="{!! asset('css/jquery-slimscroll/jquery.slimscroll.min.js')!!}" type="text/javascript"></script>
        <script src="{!! asset('css/jquery.blockui.min.js') !!}" type="text/javascript"></script>
        <script src="{!! asset('css/bootstrap-switch/js/bootstrap-switch.min.js') !!}" type="text/javascript"></script>
        <!-- END CORE PLUGINS -->
        ...
        <script src="{!! asset('js/layout3/scripts/layout.min.js') !!}" type="text/javascript"></script>
        <script src="{!! asset('js/layout3/scripts/demo.min.js') !!}" type="text/javascript"></script>
