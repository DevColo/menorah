                    ...
                    <div class="row">                           <!---K-->
                            <div class="portlet light bordered"  id="form_wizard_1">
                                ...
                                <div class="portlet-body form">
                                    <form class="form-horizontal" action="{{route('addStaff.store')}}" id="submit_form" enctype="multipart/form-data" method="POST">  {{ csrf_field() }}
                                               ...
                                               <strong>{{ $errors->first('fName') }}</strong>
                                                ...
                                                <strong>{{ $errors->first('mName') }}</strong>
                                                    ...
                                                    <div class="tab-pane" id="tab3">
                                                     ...
                                                     <div class="col-md-4">
                                                                <input type="text" class="form-control" name="role" value="Soltiamon" required />
                                                                 @if ($errors->has('role'))
                                                              <span class="help-block">
                                                    ...
                                                    @foreach($staffCampus as $keys=>$value)   
                                                    <option value="{!!$keys!!}">
                                                    {!!$value!!}</option>
                                                    @endforeach       
                                                                </select>
                                                   ...
                                                   <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input class="form-control" id="mask_date" name="eDate" type="text" />
